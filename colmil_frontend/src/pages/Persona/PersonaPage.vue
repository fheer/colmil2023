<template>
    <div>
        ...
        <div class="page-header-title">
            <br />
            <h4 class="page-title">{{ $t("nav.Cadete") }}</h4>
        </div>
        ...
        <!-- vista de consulta-->
        <b-modal ref="view-persona" size="lg" title="Cadete">
            <div class="row">
                <div class="col-md-6">
        ...
        <!-- vista de consulta-->
        <b-modal ref="frm-persona" size="xl" title="Cadete">
            <form role="form">
                <div class="form-row">
...
<script src="./PersonaPage.js"></script>